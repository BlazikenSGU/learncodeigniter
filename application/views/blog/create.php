					...
					<div class="main-content">
						<div class="main-content-inner">
							<div class="main-content-wrap">
								...
								<div class="wg-box">
									<form class="form-new-product form-style-1" action="<?php echo base_url('blog/store') ?>" method="POST" enctype="multipart/form-data">
										<fieldset class="name">
											<div class="body-title">Blog Name <span class="tf-color-1">*</span></div>


											<input class="flex-grow" type="text" placeholder="Blog name" name="title" id="slug" onkeyup="ChangeToSlug();" tabindex="0" value="" aria-required="true" required="">
										</fieldset>
										<fieldset class="name">
											<div class="body-title">Blog Slug <span class="tf-color-1">*</span></div>

											<input class="flex-grow" type="text" placeholder="Blog Slug" name="slug" id="convert_slug" tabindex="0" value="" aria-required="true" required="">
										</fieldset>
										...
										<fieldset class="description">
											...
											<textarea placeholder="Blog Description" class="mb-10" name="description" tabindex="0" aria-required="true" required=""></textarea>
