					...
					<div class="main-content">
						...
						<div class="main-content-inner">
							...
							<div class="main-content-wrap">
								...
								<form class="tf-section-2 form-add-product" method="POST" enctype="multipart/form-data" action="<?php echo base_url('product/store') ?>">
									...
									<div class="wg-box">
										...
										<fieldset class="name">
											...
											<input required class="mb-10" type="text" id="slug" onkeyup="ChangeToSlug();" name="title" tabindex="0" value="" aria-required="true" placeholder="nhap name">
										</fieldset>

										<fieldset class="name">
											<div class="body-title mb-10">Slug <span class="tf-color-1">*</span></div>
											<input class="mb-10" type="text" id="convert_slug" name="slug" tabindex="0" value="" aria-required="true" required="">
										</fieldset>
										...
										<fieldset class="name">
											...
											<input class="mb-10" type="text" name="price" tabindex="0" value="" aria-required="true" required="">
										</fieldset>

										<fieldset class="name">
											<div class="body-title mb-10">Quantity <span class="tf-color-1">*</span>
											</div>
											<input class="mb-10" type="text" name="quantity" tabindex="0" value="" aria-required="true" required="">
										</fieldset>
