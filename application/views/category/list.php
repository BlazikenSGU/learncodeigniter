							...
							<div class="main-content-wrap">
								...
								<div class="wg-box">
									<div class="flex items-center justify-between gap10 flex-wrap">
										...
										<a class="tf-button style-1 w208" href="<?php echo base_url('category/create') ?>"><i class="icon-plus"></i>Add new</a>
									</div>
											...
											<tbody>
												...
												?>
													<tr>
														...
														<td>
															<img style="max-width: 100px; max-height: 100px" src="<?php echo base_url('uploads/category/' . $bra->image) ?>" alt="">
														</td>
														...
														<td>
															<div class="list-icon-function">
																<a href="<?php echo base_url('category/edit/' . $bra->id) ?>">
																	<div class="item edit">
																		<i class="icon-edit-3"></i>
																	</div>
																</a>
																<a onclick="return confirm('Are you sure?')" href="<?php echo base_url('category/delete/' . $bra->id) ?>">
