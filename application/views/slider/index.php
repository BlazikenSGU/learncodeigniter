							...
							<div class="main-content-wrap">
								<div class="flex items-center flex-wrap justify-between gap20 mb-27">
									...
									<ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
										...
										<li>
											<div class="text-tiny">All Slider</div>
										</li>
									</ul>
								</div>
								...
								<div class="wg-box">
									<div class="flex items-center justify-between gap10 flex-wrap">
										...
										<a class="tf-button style-1 w208" href="<?php echo base_url('slider/create') ?>"><i class="icon-plus"></i>Add new</a>
									</div>
											...
											<tbody>
												...
												?>
													<tr>
														...
														<td>
															<img style=" max-height: 200px" src="<?php echo base_url('uploads/slider/' . $bra->image) ?>" alt="">
														</td>
														...
														<td>
															<div class="list-icon-function">
																<a href="<?php echo base_url('slider/edit/' . $bra->id) ?>">
																	<div class="item edit">
																		<i class="icon-edit-3"></i>
																	</div>
																</a>
																<a onclick="return confirm('Are you sure?')" href="<?php echo base_url('slider/delete/' . $bra->id) ?>">
