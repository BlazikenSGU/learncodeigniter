		...
		<nav class="limiter-menu-desktop container">
			...
			<div class="menu-desktop">
				<ul class="main-menu">
					...
					<li class="<?= (isset($_SERVER['REQUEST_URI']) && strpos($_SERVER['REQUEST_URI'], 'shop') !== false) ? 'active-menu' : '' ?> ">
...
<div class="wrap-header-mobile">
	...
	<div class="logo-mobile">
		<a href="index.html"><img src="link/images/icons/logo-01.png" alt="IMG-LOGO"></a>
	</div>
